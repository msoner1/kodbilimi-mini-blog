...
<body style="background-image: url(images/bg.png);background-repeat: repeat;">
    ...
    <table align="center" width="800" style="margin-top:20px;margin-bottom:100px;" >
             ...
             <tr><td>Soru</td><td><input type="text" id="1" value = "{if isset($gelen_veriler)}{$gelen_veriler['soru']}{/if}" name="baslik" maxlength="80" placeholder="maksimum 80 karakter" size="50" /></td></tr>
             <tr><td>Cevap</td><td><textarea name="icerik" id="2" placeholder="Html etiketlerinini kullabilirsiniz" cols="60" rows="15" >{if isset($gelen_veriler)}{$gelen_veriler['cevap']}{/if}</textarea></td></tr>
             ...
             <tr><td>Soru'ya resim upload edin</td><td><input type="file" name="upload_resim" /></td></tr>
