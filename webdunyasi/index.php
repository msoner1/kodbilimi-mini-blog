<?php
    ...
    $sqlsorgu = mysql_query("SELECT * FROM konular where kategori='webdunyasi'");
...
<html lang="tr-TR">
 <head>
  ...
  <title>kodbilimi.com | Web Dünyası</title>
  <meta name="robots" content="index, follow" />
  <meta name="viewport" content="width=500px"  />
  <meta name="description" content="Web Dünyasının merak edilenleri, html, css, php kodları" />
 ...
 <body style="margin-top:<?php $tar=$_SERVER['HTTP_USER_AGENT']; if(stripos($tar,"firefox")){echo "-23px";} else{echo "-20px";} ?>;">
  ...
  <section>
   <div id ="ana">
    <div id="icerik">
	 <div class="anabaslik"><img src="../img/web.png" alt="web simgesi" width="35" height="35" style="margin-top:15px;margin-right:10px;margin-bottom:5px;float:left;" /><h1 style="font-size:25px;line-height:18px;margin-bottom:15px;"> Web Dünyası</h1></div>
	 ...
	 <?php
      ...
      if(! $baglan) die ("Mysql Baglantisi Yapilamadi");
      @mysql_select_db($database,$baglan) or die ("Veri Tabanina Baglanti Yapilamadi"); 
      $sqlsorgu = mysql_query("SELECT * FROM konular where kategori='webdunyasi' Order By yayin_tarihi desc  LIMIT 10 OFFSET ".$ofset." ");
	 ?>
	 <div class="konular">
	 <?php
