...
<html lang="tr-TR">
 ...
 <body style="margin-top:<?php $tar=$_SERVER['HTTP_USER_AGENT']; if(stripos($tar,"firefox")){echo "-23px";} else{echo "-20px";} ?>;" >
  ...
  <section>
   <div id ="ana">
    <div id="icerik">
     <div class="anabaslik"><img src="../img/web.png" alt="web simgesi" width="35" height="35" style="margin-top:15px;margin-right:10px;margin-bottom:5px;float:left;" /><h3 style="font-size:25px;line-height:18px;margin-bottom:15px;"> Web Dünyası</h3></div>
	 <img class="soru_resmi" src="<?php echo $yazdir['konu_resmi']; ?>" alt="<?php echo $yazdir['konu_baslik']; ?>" />
	 <?php
