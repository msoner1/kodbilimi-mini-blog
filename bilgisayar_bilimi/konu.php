...
<html lang="tr-TR">
 ...
 <body style="margin-top:<?php $tar=$_SERVER['HTTP_USER_AGENT']; if(stripos($tar,"firefox")){echo "-23px";} else{echo "-20px";} ?>;" >
  <?php
   include("../kodlar/menu.php");echo '<style>#menu{position:fixed;}</style>';
  ...
  <section>
   <div id ="ana">
    <div id="icerik">
     <div class="anabaslik"><img src="../img/pc.png" alt="pc simgesi" width="35" height="35" style="margin-top:15px;margin-right:10px;margin-bottom:5px;float:left;" /><h3 style="font-size:25px;line-height:18px;margin-bottom:5px;"> Bilgisayar Bilimi</h3></div>
	 <img class="soru_resmi" src="<?php echo $yazdir['konu_resmi']; ?>" alt="<?php echo $yazdir['konu_baslik']; ?>" width="80%" height="450" />
	 <?php
	 echo '<img style="float:left;position:relaitive;margin-right:5px;" src="../img/zaman.png" alt="zaman simgesi" width="15" height="15" /><p class="tarih" style="float:left;position:relaitive;margin-right:25px;">'.$newdate.'</p><h1 class="soru">-'.$metin.'</h1>';
