<?php
    ...
    $sqlsorgu = mysql_query("SELECT * FROM konular where kategori='photoshop'");
...
<html lang="tr-TR">
 <head>
  ...
  <title>kodbilimi.com | Photoshop</title>
  <meta name="robots" content="index, follow" />
  <meta name="viewport" content="width=500"  />
  <meta name="description" content="Geliştiricilerin ve web dünyasının vazgeçilmezi photoshopun merak edilen yönleri videolu ve yazılı anlatımlarıyla kodbiliminde" />
  ...
  <section>
   <div id ="ana">
    <div id="icerik">
	 <div class="anabaslik"><img src="../img/shop.png" alt="photoshop simgesi" width="35" height="35" style="margin-top:15px;margin-right:10px;margin-bottom:5px;float:left;" /><h1 style="font-size:25px;line-height:18px;margin-bottom:15px;"> Photoshop</h1></div> 
	 <?php
	  $ofset=($sayfa-1)*10;
	  $baglan = @mysql_connect($host,$dbuser,$dbpass);
	  mysql_query("SET NAMES UTF8");
      if(! $baglan) die ("Mysql Baglantisi Yapilamadi");
      @mysql_select_db($database,$baglan) or die ("Veri Tabanina Baglanti Yapilamadi"); 
      $sqlsorgu = mysql_query("SELECT * FROM konular where kategori='photoshop' Order By yayin_tarihi desc  LIMIT 10 OFFSET ".$ofset." ");
	 ?>
	 <div class="konular">
	 <?php
